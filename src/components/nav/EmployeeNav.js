...
export const EmployeeNav = () => {
    ...
    return (
        <ul className="navbar">
            ...
            <li className="navbar_employees">
                <Link className="employees" to="/employees">Employees</Link>
            </li>
            <li className="navbar_customers">
                <Link className="customers" to="/customers">Customers</Link>
            </li>
